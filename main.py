...
def main():
    ...
    sparsity_list = list(range(1, 21))

    results = Experiments.benchmark_all_metrics(A, x0, xf,K=25,sparsity_list=sparsity_list,methods=["POMP", "LASSO", "RIDGE"])
